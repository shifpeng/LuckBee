    ...
    <ul class="layui-nav layui-nav-tree layui-inline" lay-filter="demo" style="margin-right: 10px;">
        ...
        <li class="layui-nav-item layui-nav-itemed">
            ...
            <dl class="layui-nav-child" style="margin-bottom: 0px;">
                ...
                <dd><a href="<?= Url::toRoute("cert/index") ?>"><?= "用户认证信息" ?></a></dd>
                <!--                <dd><a href="--><? //= Url::toRoute("user-product-blacklist/search") ?><!--">-->
                <? //= "撞库黑名单[生产]" ?><!--</a></dd>-->
                <!--                            --><?php //endforeach;?>
            </dl>
        </li>
        <li class="layui-nav-item  layui-nav-itemed">
            ...
            <dl class="layui-nav-child">
                ...
                <dd><a href="<?= Url::toRoute("user-product-blacklist/search") ?>"><?= "用户产品黑名单" ?></a></dd>
                <!--                <dd><a href="--><? //= Url::toRoute("api-log/search") ?><!--">-->
                <? //= "对接门面请求日志" ?><!--</a></dd>-->
                <!--                        <dd ><a  href="-->
